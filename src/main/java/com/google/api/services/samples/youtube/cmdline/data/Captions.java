...
public class Captions {
    ...
    public static void main(YouTube youtube) {
...
//                    .setApplicationName("youtube-cmdline-captions-sample").build();
            ...
            switch (action) {
              case UPLOAD:
                uploadCaption(getVideoId(), getLanguage(), getName(), getCaptionFromUser(), youtube);
                break;
              case LIST:
                listCaptions(getVideoId(), youtube);
                break;
              case UPDATE:
                updateCaption(getCaptionIDFromUser(), getUpdateCaptionFromUser(), youtube);
                break;
              case DOWNLOAD:
                downloadCaption(getCaptionIDFromUser(), youtube);
                break;
              case DELETE:
                deleteCaption(getCaptionIDFromUser(), youtube);
                break;
              default:
                ...
                uploadCaption(videoId, getLanguage(), getName(), getCaptionFromUser(),youtube);
                List<Caption> captions = listCaptions(videoId,youtube);
                if (captions.isEmpty()) {
                    ...
                    updateCaption(firstCaptionId, null,youtube);
                    downloadCaption(firstCaptionId,youtube);
                    deleteCaption(firstCaptionId,youtube);
                }
            }
     ...
     * @throws IOException
     */
    private static void deleteCaption(String captionId, YouTube youtube) throws IOException {
     ...
     * @throws IOException
     */
    private static void downloadCaption(String captionId, YouTube youtube) throws IOException {
     ...
     * @throws IOException
     */
    private static void updateCaption(String captionId, File captionFile, YouTube youtube) throws IOException {
     ...
     * @throws IOException
     */
    private static List<Caption> listCaptions(String videoId, YouTube youtube) throws IOException {
    ...
    private static void uploadCaption(String videoId, String captionLanguage,
                                      String captionName, File captionFile, YouTube youtube) throws IOException {
